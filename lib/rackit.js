 ...
 * @param {Object.<string, string>} hMeta - Any extra meta data to add
 * @param {function(err, sContainer, sName)} cb
 */
Rackit.prototype.add = function(sFile, sType, hMeta, cb) {
	var o1 = this;
	hMeta = hMeta || {};
	...
	function(err, results) {
		...
		var sKey;
		for(sKey in hMeta) {
			if(hMeta.hasOwnProperty(sKey)) {
				headers['x-object-meta-' + sKey] = hMeta[sKey];
			}
		}
 ...
 * @param {function()} cb
 */
Rackit.prototype.setMeta = function(sCloudPath, hMeta, cb) {
	var o1 = this;
	var headers = {};
...
Rackit.prototype.getURI = function(sCloudPath) {
	...
	return CDNContainer['cdn_uri'] + '/' + sFile;
};
